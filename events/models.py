...
class Shop(models.Model):
    ...
    branch_code = models.CharField(max_length=10, default=None)
    pivot_icon = models.ImageField(null=True)
    x_pivot = models.FloatField(default=0)
    y_pivot = models.FloatField(default=0)
    create_date = models.DateTimeField('date published',default=None)
    create_by = models.CharField(max_length=50, default=None)
    updated_date = models.DateTimeField('date published',default=None)
